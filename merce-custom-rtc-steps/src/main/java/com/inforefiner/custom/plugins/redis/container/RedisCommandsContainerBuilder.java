package com.inforefiner.custom.plugins.redis.container;

import com.inforefiner.custom.plugins.redis.config.FlinkJedisClusterConfig;
import com.inforefiner.custom.plugins.redis.config.FlinkJedisConfigBase;
import com.inforefiner.custom.plugins.redis.config.FlinkJedisPoolConfig;
import com.inforefiner.custom.plugins.redis.config.FlinkJedisSentinelConfig;
...
public class RedisCommandsContainerBuilder {
     ...
     */
    private static RedisCommandsContainer build(FlinkJedisPoolConfig jedisPoolConfig) {
     ...
     */
    private static RedisCommandsContainer build(FlinkJedisClusterConfig jedisClusterConfig) {
     ...
     */
    private static RedisCommandsContainer build(FlinkJedisSentinelConfig jedisSentinelConfig) {
